...
export class MailService {
    ...
    async envioCorreoAprobacionHorasNoDisponibles(solicitud: SolicitudHoraNoDisponibleEntity) {
    ...
    async envioCorreoRechazoHorasNoDisponibles(solicitud: SolicitudHoraNoDisponibleEntity) {
        return await this.mailerService.sendMail({
            to: solicitud.docente.correoElectronico,
