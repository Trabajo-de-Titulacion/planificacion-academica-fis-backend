...
export class SolicitudHoraNoDisponibleEntity {
    ...
    @Column({ enum: ESTADO_SOLICITUD_HORA_NO_DISPONIBLE, default: ESTADO_SOLICITUD_HORA_NO_DISPONIBLE.POR_REVISAR})
    estado: ESTADO_SOLICITUD_HORA_NO_DISPONIBLE

    @OneToMany(() => HoraNoDisponibleEntity, horaNoDisponible => horaNoDisponible.solicitud, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
