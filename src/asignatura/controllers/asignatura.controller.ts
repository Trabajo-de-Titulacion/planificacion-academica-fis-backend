...
export class AsignaturaController {
  ...
  @ApiOperation({
    summary:
      configuraciones.controladores.asignatura.operaciones
        .crearVariasAsignaturas.descripcion,
  })
  @Post(
    configuraciones.controladores.asignatura.operaciones.crearVariasAsignaturas
      .ruta,
  )
  ...
  @ApiOperation({
    summary:
      configuraciones.controladores.asignatura.operaciones
        .actualizarAsignaturaPorID.descripcion,
  })
  @Put(
    configuraciones.controladores.asignatura.operaciones
  ...
  actualizarAsignaturasPorID(
    ...
    asignaturaDto.codigo = asignaturaDto.codigo.toUpperCase().trim();
    asignaturaDto.nombre = asignaturaDto.nombre.toUpperCase().trim();
    return this.asignaturaService.actualizarAsignaturaPorID(
      idAsignatura,
      asignaturaDto,
    );
  }
  ...
  @ApiOperation({
    summary:
      configuraciones.controladores.asignatura.operaciones
        .eliminarAsignaturaPorID.descripcion,
  })
  @Delete(
  ...
  @ApiOperation({
    summary:
      configuraciones.controladores.asignatura.operaciones
        .obtenerAsignaturaPorCodigo.descripcion,
  })
  @Get(
    configuraciones.controladores.asignatura.operaciones
