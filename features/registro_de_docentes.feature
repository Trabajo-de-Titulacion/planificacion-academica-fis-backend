			...
			Entonces al leer la dase de datos se podrá observar que todos los docentes registrados tienen un código
			...
			| Juan José Gómez Tusa     | diana.lopez03@epn.edu.ec             | D:\Proyectos Codigo\TrabajoDeTitulacion\planificacion-academica-fis-backend\features\documents_test\registro_de_docentes_0_fallo.csv | Correos electrónicos enviados            |
			| Juan José Gómez Tusa     | diana.lopez03@epn.edu.ec             | D:\Proyectos Codigo\TrabajoDeTitulacion\planificacion-academica-fis-backend\features\documents_test\registro_de_docentes_3_fallo.csv | Existen correos electrónicos no enviados |
