			...
			| Juan José Gómez Tusa     | luis.llanganate@epn.edu.ec           | registro_de_docentes_0_fallo.csv | Se han creado exitosamente 2 docentes. Se envió un correo electrónico con el código de acceso a cada uno de los docentes.                                                                                     |
			| Juan José Gómez Tusa     | luis.llanganate@epn.edu.ec           | registro_de_docentes_1_fallo.csv | Se han creado exitosamente 2 docentes y se ha enviado un correo electrónico con el código de acceso a cada uno. No se pudo crear a los docentes: PEPE JOSE LUCIO NARANJO, ya que, existen dentro del sistema. |
